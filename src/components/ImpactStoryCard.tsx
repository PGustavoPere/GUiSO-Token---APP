          ...
          >
            ...
            <div className="relative h-48">
              ...
              <div className="absolute bottom-6 left-8">
                <div className="bg-guiso-orange text-white px-4 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest mb-2 inline-block">
                  Historia de Impacto
                </div>
                <h3 className="text-3xl font-display font-bold text-guiso-dark">El Efecto GUISO</h3>
              </div>
            </div>
