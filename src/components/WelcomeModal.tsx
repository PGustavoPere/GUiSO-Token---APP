...
export default function WelcomeModal() {
  ...
  const steps = [
    { icon: <User className="w-5 h-5 text-guiso-orange" />, text: "1️⃣ Usuario: Conectas tu identidad digital" },
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          ...
          >
            ...
            <div className="px-6 pt-6 pb-2 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 mb-3 rounded-xl bg-guiso-orange/10 text-guiso-orange">
            ...
            <div className="p-5 mt-2 bg-slate-50/50 border-t border-slate-100">
              ...
              <button
                onClick={handleClose}
                className="w-full py-3.5 text-sm font-bold text-white transition-all shadow-lg rounded-xl bg-guiso-orange hover:bg-guiso-terracotta active:scale-[0.98] shadow-guiso-orange/20"
              >
                Comenzar
              </button>
            </div>
